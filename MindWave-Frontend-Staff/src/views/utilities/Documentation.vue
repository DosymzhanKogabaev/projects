<template>
    <div class="card">
        ...
        <p>
            Avalon is an application template for Vue 3 based on <a href="https://github.com/vuejs/create-vue" class="font-medium text-primary hover:underline">create-vue</a>, the recommended way to start a <strong>Vite-powered</strong> Vue projects.
        ...
        <p>Next step is running the application using the serve script and navigate to <i>http://localhost:5173/</i> to view the application. That is it, you may now start with the development using the Avalon template.</p>

        <pre class="app-code"><code>npm run dev</code></pre>

        <h4>Structure</h4>
        <p>Avalon consists of a couple folders, demos and layout have been separated so that you can easily remove what is not necessary for your application.</p>
...
&#125;,</code></pre>
        ...
        <p>Only the folders that are related to the layout needs to move in to your project. We've created a short tutorial with details. It is based on Sakai but flow is exactly the same with Avalon.</p>
        ...
        <p>
            Avalon provides 20 PrimeVue themes out of the box. Setup of a theme is simple by including the css of theme to your bundle that are located inside <span class="text-primary font-medium">public/layout/styles/theme/</span> folder such as
        ...
        <pre class="app-code"><code>$primaryLightColor: rgba(38,143,255,.5) !default;
...
$highlightTextColor: $primaryAccentBg !default;
...
@import '../../_extensions';
        ...
        <p>
            Avalon includes <a href="https://github.com/primefaces/primevue-sass-theme" class="font-medium text-primary hover:underline">PrimeVue Sass Theme</a> internally. Visit
        ...
        <h4>TopBar Theme</h4>
        <p>
            Theming of the topbar has 22 options to choose from, still if you'd like to create your own theme then create a file like <span class="text-primary font-medium">_topbar_mytopbar</span> under
    ...
    --topbar-menu-button-text-color: #6f42c1;
...
&#125;
        ...
        <pre class="app-code"><code>layoutConfig = reactive(&#123;
    //...
    topbarTheme: "mytheme"
    //...
&#125;)</code></pre>
        ...
        <h4>Menu Theme</h4>
        <p>
            Main menu offers 2 built-in themes and building your own theme is quite trivial. First create a file like <span class="text-primary font-medium">_menu_mymenu</span> under
