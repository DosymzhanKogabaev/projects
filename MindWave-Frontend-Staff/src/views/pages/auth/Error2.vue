        ...
        <div class="flex align-items-center justify-content-center relative">
            <div class="h-screen flex justify-content-center align-items-center w-full lg:w-6">
                <div class="z-5 w-6 h-6">
                    <i class="pi pi-exclamation-triangle text-2xl bg-red-500 p-1 px-2 border-round-md text-white"></i>
                    <h1 class="text-6xl font-light my-4 mx-0 text-red-500">Error Occured</h1>
                    <Divider class="w-7rem"></Divider>
                    <p class="mt-4 text-lg text-color">Something went wrong.</p>
                    <Button label="Go To Dashboard" @click="navigateToDashboard" class="mt-5 border-none bg-red-500"></Button>
                </div>
            </div>
        </div>
