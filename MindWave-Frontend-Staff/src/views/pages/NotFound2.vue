...
<template>
    <div class="fixed w-full h-full top-0 left-0 opacity-70 bg-primary-reverse">
        <div class="flex align-items-center justify-content-center relative">
            <div class="w-full flex justify-content-end align-items-start absolute top-0 left-0 z-1"></div>
            <div class="h-screen flex justify-content-center align-items-center w-full lg:w-6">
                <div class="z-5 w-6 h-6">
                    <span class="text-lg bg-bluegray-500 p-1 px-2 border-round-md text-900">404</span>
                    <h1 class="text-6xl font-light my-4 mx-0 text-bluegray-500">Page Not Found</h1>
                    <div class="w-7rem bg-bluegray-500" style="height: 1px"></div>
                    <p class="mt-4 text-lg text-900">Requested resource is not available right now. Please try again later.</p>
                    <Button @click="navigateToDashboard" label="Go To Dashboard" class="mt-5 border-none" style="background-color: #5e81ac"></Button>
                </div>
            </div>
