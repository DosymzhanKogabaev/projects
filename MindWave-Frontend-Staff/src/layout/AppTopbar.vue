                            ...
                            <ul class="list-none p-0 m-0 flex flex-column text-color">
                                <li>
                                    <a class="cursor-pointer flex align-items-center px-3 py-2 gap-3 hover:text-primary">
                                        <img src="/layout/images/avatar/avatar5.png" class="w-3rem h-3rem" />
                                        <span>Give me a call</span>
                                    </a>
                                </li>
                                <li>
                                    <a class="cursor-pointer flex align-items-center px-3 py-2 gap-3 hover:text-primary">
                                        <img src="/layout/images/avatar/avatar1.png" class="w-3rem h-3rem" />
                                        <span>Sales reports attached</span>
                                    </a>
                                </li>
                                <li>
                                    <a class="cursor-pointer flex align-items-center px-3 py-2 gap-3 hover:text-primary">
                                        <img src="/layout/images/avatar/avatar2.png" class="w-3rem h-3rem" />
                                        <span>About your invoice</span>
                                    </a>
                                </li>
                                <li>
                                    <a class="cursor-pointer flex align-items-center px-3 py-2 gap-3 hover:text-primary">
                                        <img src="/layout/images/avatar/avatar3.png" class="w-3rem h-3rem" />
                                        <span>Meeting today at 10pm</span>
                                    </a>
                                </li>
                                <li>
                                    <a class="cursor-pointer flex align-items-center px-3 py-2 gap-3 hover:text-primary">
                                        <img src="/layout/images/avatar/avatar4.png" class="w-3rem h-3rem" />
