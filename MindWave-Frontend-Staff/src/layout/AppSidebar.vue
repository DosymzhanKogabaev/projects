...
<template>
    <div class="layout-sidebar" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave">
        ...
        <AppMenuProfile v-if="layoutConfig.menuProfilePosition.value === 'start'"></AppMenuProfile>
        <div class="layout-menu-container">
            <AppMenu />
        </div>
        <AppMenuProfile v-if="layoutConfig.menuProfilePosition.value === 'end'"></AppMenuProfile>
    </div>
</template>
