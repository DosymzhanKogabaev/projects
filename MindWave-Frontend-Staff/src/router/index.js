		...
		children: [
			{
                ...
                name: 'timezones',
                component: () => import('@/views/settings/Timezones.vue'),
                meta: {
                    breadcrumb: [{ parent: 'Settings', item: 'Timezones' }]
                }
            },
            {
                path: '/categories',
                ...
                meta: {
                    breadcrumb: [{ parent: 'Settings', item: 'Categories' }]
                }
            },
			{
			...
			{
				path: '/dynamic-table/:table',
				name: 'dynamic-table',
				component: () => import('@/views/dashboards/DynamicTable2.vue'),
				meta: {
					breadcrumb: [{ parent: 'Dynamic-Table' }]
				}
			},
			{
				path: '/test2',
				name: 'test2',
				component: () => import('@/views/dashboards/Test2.vue'),
				meta: {
					breadcrumb: [{ parent: 'Test2' }]
				}
			},
			{
				path: '/apps/blog/list',
